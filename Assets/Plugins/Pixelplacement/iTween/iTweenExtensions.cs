...
{	
    ...
    public static void MoveTo(this GameObject go, Vector3[] path, float time, float delay, EaseType easeType, bool ignoreTimeScale)
    {
        iTween.MoveTo(go, iTween.Hash("path", path, "time", time, "delay", delay, "easeType", easeType.ToString(), "ignoretimescale", ignoreTimeScale));
    }
    ...
    public static void RotateBy(this GameObject go, Vector3 amount, float time, float delay, EaseType easeType, LoopType loopType, bool ignoretimescale)
    {
        iTween.RotateBy(go, iTween.Hash("amount", amount, "time", time, "delay", delay, "easeType", easeType.ToString(), "looptype", loopType.ToString(), "ignoretimescale", ignoretimescale));
    }
